...
from NetworkLit import AGFModuleLit
...
if __name__ == '__main__':
    ...
    logger = TensorBoardLogger("lightning_logs", name="AGF/" + args.dataset_path.split("/")[-1])
    ...
    torch.save(model.model.state_dict(), "lightning_logs/AGF_module_"+args.robot+".pt")
